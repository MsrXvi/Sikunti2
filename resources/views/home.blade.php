                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Jumlah Kelas</p>
                                        <span class="title text-black font-w600">{{ $total_kelas }}</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Angkatan</p>
                                        <span class="title text-black font-w600">{{ $total_angkatan }}</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Tagihan</p>
                                        <span class="title text-black font-w600">{{ $total_tagihan }}</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>Dokumen Mahasiswa Angkatan</th>
                    ...
                    <div class="col-lg-12">
                        <div class="card bg-gra"
                            ...
                            <div class="card-body">
                                <div class="row d-flex">
                                    <div class="col-md-8">
                                        <h4 class="text-bold text-weight-bolder"
                                            ...
                                            <img src="https://img.freepik.com/premium-vector/cute-indonesian-ghost-kuntilanak-vector-illustration_547110-118.jpg?w=740"
                                                width="28" alt="" style="margin-top: -3px">
                                            SIKUNTI<span style="font-size: 14px;"> Sistem Keuangan Informatika</span>
                                        </h4>
                                        <span class="mb-5">January 01,
                                            2024</span>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="mt-4">
                                    <h5 class="mb-0" style="color: #008eff">Selamat Datang, Muh. Syahri Romadhoni</h5>
                                </div>
                            </div>
                        </div>
                    </div>
